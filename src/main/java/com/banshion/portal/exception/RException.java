...
public class RException extends Exception {
	...
	private static final long serialVersionUID = -5815973353428240769L;
	// 自定义异常消息
	 ...
	 * 
	 */
	public RException(String message, Object... paras) {
		super();
	 ...
	 * 
	 */
	public RException(String message, Throwable cause, Object... paras) {
		super(cause);
		this.setMessage(getExceptionMessage(message, paras));
	}
