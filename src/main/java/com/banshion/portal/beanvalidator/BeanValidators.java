 ...
 */
package com.banshion.portal.beanvalidator;
...
public class BeanValidators
{
     ...
     */
    public static String extractPropertyAndMessageAsString(final Set<? extends ConstraintViolation> constraintViolations, String separator, final String prefix, final String postfix){
        StringBuilder builder = new StringBuilder();
        for (ConstraintViolation violation : constraintViolations) {
            builder.append(prefix).append(violation.getPropertyPath()).append(separator).append(violation.getMessage()).append(postfix);
        }
